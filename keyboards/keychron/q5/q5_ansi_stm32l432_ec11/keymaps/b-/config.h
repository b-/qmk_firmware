...
//#define RGB_MATRIX_STARTUP_HUE 236  //pink  alphas with green background when pressed.
#define RGB_MATRIX_STARTUP_HUE 244  //pink  alphas with green background when pressed.
